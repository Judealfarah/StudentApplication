...
class Monday : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        resetCBu.setOnClickListener {
            ...
            val builder = AlertDialog.Builder(this@Monday)
    ...
    private fun loadMon(username: String){
        myRef.child(username).child("Monday").addValueEventListener(object : ValueEventListener {
