...
class Schedule : AppCompatActivity() {
    ...
    private fun loadSun(username: String){

        val sunRef = myRef.child(username).child("Sunday")
        sunRef.addValueEventListener(object : ValueEventListener {
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@Schedule, error.toString(), Toast.LENGTH_LONG).show()
            }
