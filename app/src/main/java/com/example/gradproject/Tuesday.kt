...
class Tuesday : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        resetCBu.setOnClickListener {
            ...
            val builder = AlertDialog.Builder(this@Tuesday)
    ...
    private fun loadTues(username: String){
        myRef.child(username).child("Tuesday").addValueEventListener(object : ValueEventListener {
